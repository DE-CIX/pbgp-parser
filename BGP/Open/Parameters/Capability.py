...
from BGP.Exceptions import BGPCapabilityFactoryError
from BGP.Open.OptionalParameter import BGPOptionalParameter
...
class BGPCapability:
    ...
    def factory(capability_type, payload):
        ...
        if capability_type == BGPStatics.CAPABILITY_MULTIPROTOCOL_EXTENSIONS:
            from BGP.Open.Parameters.Capabilities.MultiprotocolExtensions import CapabilityMultiprotocolExtensions
