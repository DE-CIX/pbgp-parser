...
class BGPMessage:
    ...
    def factory(payload, pcap_information):
        ...
        if message_type == BGPStatics.MESSAGE_TYPE_ROUTE_REFRESH:
            from BGP.RouteRefresh.Message import BGPRouteRefreshMessage
