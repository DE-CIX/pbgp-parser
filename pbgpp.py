...
group_5.add_argument("--fields", help="specify the output-fields to be display in the order desired; separated by comma", dest="fields", default="message.timestamp,message.type,message.ip.source,message.ip.destination")
